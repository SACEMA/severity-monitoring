...
secondary_ts <- generate_secondary_two_ratio(
  primary = primary_ts,
  delay = in.fixed_delay,
  ratio1 = in.prop_to_secondary,
  ratio2 = in.prop_to_secondary2,
  tchange_prim = tchange_prim
)
...
saveRDS(reported_data, "./synthetic/data/linear-ts-two-ratios.rds")
